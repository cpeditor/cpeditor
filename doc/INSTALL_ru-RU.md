> Внимание! Данный перевод может быть устаревшим и не соответствовать полноценному переводу актуальной версии документа на английском языке. [Здесь](INSTALL.md) вы можетет прочитать оригинал этой страницы (на английском).
...
На Linux дистрибутивах, основанных на Debian (Ubuntu, Linux Mint и т.д.) вы можете скачать `.deb`-пакет и запустить команду в терминале:

    ```sh
    sudo apt install ./<путь до .deb-пакета>
    ```

Далее введите Ваш пороль от root и согласитесь с установкой. Вы также можете использовать `Gdebi` или другую графическую утилиту для установки `deb`-пакетов. Поддерживаются: Debian 10 Buster, Ubuntu 18.04 Bionic Beaver, Linux Mint 19 Tara и более новые версии этих дистрибутивов, а также основанные на них.
