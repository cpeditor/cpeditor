...
|  type  |                           branch                           |                                                                                                       build                                                                                                        |                                               flatpak                                                |                                                         AUR                                                         |                                                snap                                                  |
| :----: | :--------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: |
| alpha  | [master](https://github.com/cpeditor/cpeditor/tree/master) | [![GitHub Workflow Status](https://github.com/cpeditor/cpeditor/actions/workflows/build_test.yml/badge.svg?branch=master&event=push)](https://github.com/cpeditor/cpeditor/actions/workflows/build_test.yml?query=branch%3Amaster+event%3Apush) | [![flatpak version](https://img.shields.io/badge/flatpak-artifact-blue)](https://github.com/cpeditor/cpeditor/actions/workflows/push_flatpak.yml) | [![AUR version](https://img.shields.io/aur/version/cpeditor-git)](https://aur.archlinux.org/packages/cpeditor-git/) |  [![snap version](https://badgen.net/snapcraft/v/cpeditor/amd64/edge)](https://snapcraft.io/cpeditor)
|  beta  |   [v7.1](https://github.com/cpeditor/cpeditor/tree/v7.1)   |   [![GitHub Workflow Status](https://github.com/cpeditor/cpeditor/actions/workflows/build_test.yml/badge.svg?branch=v7.1&event=push)](https://github.com/cpeditor/cpeditor/actions/workflows/build_test.yml?query=branch%3Av7.1+event%3Apush)   | [![flatpak version](https://img.shields.io/badge/flatpak-release-blue)](https://github.com/cpeditor/cpeditor/releases) |                                                          -                                                          |                                                   -
| stable |   [v7.0](https://github.com/cpeditor/cpeditor/tree/v7.0)   |   [![GitHub Workflow Status](https://github.com/cpeditor/cpeditor/actions/workflows/build_test.yml/badge.svg?branch=v7.0&event=push)](https://github.com/cpeditor/cpeditor/actions/workflows/build_test.yml?query=branch%3Av7.0+event%3Apush)   | [![flatpak version](https://img.shields.io/badge/flatpak-release-blue)](https://github.com/cpeditor/cpeditor/releases) |     [![AUR version](https://img.shields.io/aur/version/cpeditor)](https://aur.archlinux.org/packages/cpeditor/)     |  [![snap version](https://badgen.net/snapcraft/v/cpeditor/amd64/stable)](https://snapcraft.io/cpeditor)
...
Thanks go to these wonderful people: (if we forget to add you as a contributor, you can [add by yourself](https://allcontributors.org/docs/en/bot/usage))
