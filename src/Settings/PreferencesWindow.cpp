...
#define TRKEY(x) x, tr(x)
    ...
    AddPageHelper(this)
        ...
        .dir(TRKEY("Actions"))
            ...
            .page(TRKEY("Load External File Changes"), {"Auto Load External Changes If No Unsaved Modification", "Ask For Loading External Changes","Ask For Recompiling Checker When Changed"})
        .end()
